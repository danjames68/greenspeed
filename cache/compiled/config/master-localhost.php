...
return [
    ...
    'timestamp' => 1556563854,
    'checksum' => '8f8d1d9946de5af4f2a3af17640f1b49',
    'files' => [
        'user/config' => [
            'backups' => [
...
node_modules'
        ...
        'site' => [
            ...
            'metadata' => [
                'description' => 'GreenSpeed is a small company dedicated to building fast eco-friendly websites ready to be run on our energy efficient severs based in the UK'
            ],
            'summary' => [
                'enabled' => true,
                'format' => 'short',
            ...
            'contact' => [
                ...
                'emailTitle' => 'Email',
                'emailAddress' => 'info@greenspeedstudio.co.uk',
                'addressTitle' => 'Address',
                'addressDetails' => 'Unit 5, 30 Friern Park. North London, N12 9DA'
            ]
        ],
        'streams' => [
            'schemes' => [
        ...
        'themes' => [
            'greenspeed' => [
                'enabled' => true,
                'custom_logo' => [
                    'user/themes/greenspeed/images/logo/spiral-logo.png' => [
